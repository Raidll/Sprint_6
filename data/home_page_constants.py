...
class HomePageConstants:
    ...
    questions_and_answers = [
        [HomePage.XPATH_FIRST_QUESTION_ABOUT_IMPORTANT, HomePage.XPATH_FIRST_ANSWER_ABOUT_IMPORTANT, FIRST_QUESTION_TEXT, FIRST_ANSWER_TEXT],
        [HomePage.XPATH_SECOND_QUESTION_ABOUT_IMPORTANT, HomePage.XPATH_SECOND_ANSWER_ABOUT_IMPORTANT, SECOND_QUESTION_TEXT, SECOND_ANSWER_TEXT],
        [HomePage.XPATH_THIRD_QUESTION_ABOUT_IMPORTANT, HomePage.XPATH_THIRD_ANSWER_ABOUT_IMPORTANT, THIRD_QUESTION_TEXT, THIRD_ANSWER_TEXT],
        [HomePage.XPATH_FOURTH_QUESTION_ABOUT_IMPORTANT, HomePage.XPATH_FOURTH_ANSWER_ABOUT_IMPORTANT, FOURTH_QUESTION_TEXT, FOURTH_ANSWER_TEXT],
        [HomePage.XPATH_FIFTH_QUESTION_ABOUT_IMPORTANT, HomePage.XPATH_FIFTH_ANSWER_ABOUT_IMPORTANT, FIFTH_QUESTION_TEXT, FIFTH_ANSWER_TEXT],
        [HomePage.XPATH_SIXTH_QUESTION_ABOUT_IMPORTANT, HomePage.XPATH_SIXTH_ANSWER_ABOUT_IMPORTANT, SIXTH_QUESTION_TEXT, SIXTH_ANSWER_TEXT],
        [HomePage.XPATH_SEVENTH_QUESTION_ABOUT_IMPORTANT, HomePage.XPATH_SEVENTH_ANSWER_ABOUT_IMPORTANT, SEVENTH_QUESTION_TEXT, SEVENTH_ANSWER_TEXT],
        [HomePage.XPATH_EIGHTH_QUESTION_ABOUT_IMPORTANT, HomePage.XPATH_EIGHTH_ANSWER_ABOUT_IMPORTANT, EIGHTH_QUESTION_TEXT, EIGHTH_ANSWER_TEXT],
    ]
